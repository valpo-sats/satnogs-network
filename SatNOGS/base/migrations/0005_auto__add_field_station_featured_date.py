...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Station.featured_date'
        db.add_column(u'base_station', 'featured_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Station.featured_date'
        db.delete_column(u'base_station', 'featured_date')
