...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Transponder.satellite'
        db.add_column(u'base_transponder', 'satellite',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='transponder', null=True, to=orm['base.Satellite']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Transponder.satellite'
        db.delete_column(u'base_transponder', 'satellite_id')
